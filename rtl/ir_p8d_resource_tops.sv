...
module ir_p8d_resource_top #(
  ...
  ir_axis_tx_frontend #(.DATA_WIDTH(DATA_WIDTH),.USER_WIDTH(64)) axis_frontend (
    ...
    .descriptor_ready_o(),.descriptor_length_i({16'd0,payload_length_i}),
  ...
  ir_dma_descriptor_model #(.RING_DEPTH(64)) tx_ring (
    ...
    .cpu_buffer_capacity_i(32'd288),.cpu_requested_length_i({16'd0,payload_length_i}),
    ...
    .hw_actual_length_i({16'd0,payload_length_i}),.hw_error_code_i(16'd0),
