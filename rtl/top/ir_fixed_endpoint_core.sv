...
module ir_fixed_endpoint_core(
  ...
  ir_endpoint_core #(.LANE_COUNT(P8E_Z7020_FIXED_8LANE_LANE_COUNT),
    .WINDOW_SIZE(P8E_Z7020_FIXED_8LANE_TX_WINDOW),
    .SACK_BITS(P8E_Z7020_FIXED_8LANE_SACK_BITS),
    .PHYSICAL_MODULE_COUNT(P8E_Z7020_FIXED_8LANE_PHYSICAL_MODULE_COUNT)) u_fixed(.*);
endmodule
