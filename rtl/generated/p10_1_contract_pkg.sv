...
package p10_1_contract_pkg;
  ...
  localparam longint unsigned P10_1_RING_DEPTH = 32;
  localparam longint unsigned P10_1_DESCRIPTOR_BATCH = 8;
  ...
  localparam longint unsigned P10_1_ACK_AGGREGATION_THRESHOLD = 32;
