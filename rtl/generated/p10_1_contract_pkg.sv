...
package p10_1_contract_pkg;
  ...
  localparam longint unsigned P10_1_BUFFER_COUNT = 8;
  localparam longint unsigned P10_1_BUFFER_SIZE_BYTES = 1048576;
  localparam longint unsigned P10_1_RING_DEPTH = 64;
  localparam longint unsigned P10_1_DESCRIPTOR_BATCH = 16;
  ...
  localparam longint unsigned P10_1_ACK_AGGREGATION_THRESHOLD = 16;
