...
| F2 | AX7020-F | 2 | F2-R2 | future intake required |
| F3 | AX7020-F | 3 | F3-R3 | future intake required |
| R0 | AX7020-R | 0 | F0-R0 | accepted P10.1R baseline |
| R1 | AX7020-R | 1 | F1-R1 | accepted P10.1R baseline |
| R2 | AX7020-R | 2 | F2-R2 | future intake required |
| R3 | AX7020-R | 3 | F3-R3 | future intake required |
