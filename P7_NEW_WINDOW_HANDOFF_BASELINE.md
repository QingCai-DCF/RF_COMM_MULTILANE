...
## 54. 2026-07-15 r41 formal full-run dry preparation

- The collision audit found no prior use of `p7_20260715_stationary_app_r41_formal_full`. A new detached execution worktree at `C:\Users\user\.codex\worktrees\r41formal_946ccba\RF_COMM_MULTILANE` is bound to exact checkpoint source `946ccbad66d64d715ad6745449b95f6c261ddf76`, tree `d05bb9d85868b380800e37c94388a43dc6092347`. The 25 allowed post-gate generated outputs and nine ignored board-contract prerequisites were copied hash-exactly before plan generation. Machine materialization SHA256 is `9737e5dcfc4fecc0fca57afde88de5ca122474d440a42d20e0196aefcee4ee33`; there is no non-generated tracked dirt and no cache-hit claim.
- The formal generator produced a complete 66-stage plan, not a diagnostic suffix. Plan SHA256 is `a37d652de98239b8e654a9467b21bdcb660c3d896ad40e1415de7c8e1ed5f794`. Ordinals 1--66 are contiguous, the plan contains no `--resume`, and stationary occurs exactly once at final ordinal 66 with 1800 seconds split into 300 seconds calibration and 1500 seconds acceptance. Sixty-six fresh, unique authorizations bind exact source and artifact hashes, no Ethernet, no motion, two lanes, max mask `0x3`, and shutdown-on-exit; their canonical tree SHA256 is `0d6406a772e5705fde96e9fd61f377c36f4c4c8422f0d7a170766be45f15bb60`.
- Generator manifest SHA256 is `ea77c8d55ba6e52130c95beeffa0004b508aa40022d3f7c002a1629668119aa6`. All 66 child-wrapper dry validations passed with zero errors, and generation launched no safe wrapper, Vivado, XSDB, or hardware process. The ignored bundle has 183 files, 156,005,279 bytes, canonical tree SHA256 `a7064bb0a33d9b973adcdf0f6c7f2024da73f551bd368793d19fa729316a0195`.
- The independent plan audit passed with SHA256 `030ffa7973c0e8771dbda2c873e2017513481f7a286e93f1a3052980fb408010`. The sequence executor was separately invoked once in validation-only mode and returned `DRY_RUN_VALIDATED` for all 66 stage argv vectors with zero errors; record SHA256 is `70a984533384eb82eb146203620aeb9e583a92525d3e1d052de98e920da7bc28`. Preparation selfcheck SHA256 is `6bbfd30cdff1d0ab911d4c9bd62d5ea1d678f158035a6886c0ae8f868d0dd4e3`; final status is `evidence/generated/p7_r41_formal_preparation_status.json`.
- This preparation did not launch r41. Its evidence root and selected ledger `evidence/hardware/p7/authorized_sequence/p7_20260715_stationary_app_r41_formal_full/sequence_execution_ledger.json` do not exist, `RF_COMM_HW_AUTH` is absent, no project hardware process is active, and external `hw_server` PID 45220 remains listen-only and untouched. Stationary attempt count is zero and `HARDWARE_ACCEPTANCE=PENDING_HW`. If a later execution entry is authorized, use only this exact plan and new ID without `--resume`; stop on the first failure, preserve raw evidence, perform separate shutdown recovery if required, retire the ID on failure, and do not admit stage 66 before same-run stages 1--65 PASS.
- Main-thread specialist integration and offline/formal preparation are complete enough to report `MAIN_THREAD_RESUME_READY`. This does not mean hardware PASS, full stages 1--66 PASS, stationary PASS, or product acceptance.

## 55. 2026-07-15 r41 formal Stage 66 failure, recovery, and frozen result

- Formal run `p7_20260715_stationary_app_r41_formal_full` launched exactly once from source `946ccbad66d64d715ad6745449b95f6c261ddf76` with plan SHA256 `a37d652de98239b8e654a9467b21bdcb660c3d896ad40e1415de7c8e1ed5f794` and no `--resume`. The same run's stages 1--65 reached exact terminal PASS. Stage 66 then ended `FAIL_STAGE`; terminal ledger SHA256 is `a86ec2a8e326a5354e9e79abed71ca938a3aa7a54b6936bc961beaf668ddba64`. r41 is immutable FAIL and must never be resumed, restarted, copied, reused, or represented as acceptance coverage.
- Stage 66 was the sole authorized stationary attempt. It produced one sample and four terminal objects, then failed before 1800 seconds with exact raw error `P7_PS_STAGE_ERROR=integer value too large to represent`. `STATIONARY_30MIN=FAIL_INCOMPLETE`, stationary PASS is false, `coverage_claimed=false`, and `HARDWARE_ACCEPTANCE=PENDING_HW`. The unique stationary attempt is consumed; no further Stage 66 run is permitted under the current constraint. The four completed objects are observations only and do not prove stationary acceptance.
- Stage 66 shutdown-before and shutdown-after both passed. The separate recovery at `recovery_shutdown_after_failed_stage066_20260715T114509Z` passed with summary SHA256 `98ac97d76e89a5ad0daee44b8f277990bcd8e5bb9d55565149e1091255dd10b5`, exactly one emitted shutdown-programming marker, and normalized `SHUTDOWN_EXIT=0`. Recovery PASS does not change r41 or Stage 66 FAIL. After recovery no project hardware process remained; external `hw_server` PID 45220 was unchanged and untouched.
- The original raw evidence remains at `C:\Users\user\.codex\worktrees\r41formal_946ccba\RF_COMM_MULTILANE\evidence\hardware\p7\authorized_sequence\p7_20260715_stationary_app_r41_formal_full`: 1,808 files, 834,613,170 bytes, no partial files, canonical tree SHA256 `3501544a5fcd13458cbeb280e3e0a617430e8d8671ef8be5d90f5b6e7ebefa91`. The portable 220-file, 76,154,254-byte failure package has no partial files and canonical tree SHA256 `bf710e4207146ceb27476ab86b91d9e31bc61ef63716bc48ce41ea96f1095cb7`; machine classification is `evidence/generated/p7_r41_formal_failure.json`.
- The formal summarizer was replayed offline exactly once against the specific immutable r41 raw root. It exited one and correctly reported formal FAIL and stationary FAIL while shutdown evidence remained PASS; no hardware action occurred. Replay result SHA256 is `0460b3494670903b8fa89c3d8acf7af078d7ea1d1d6eb784494487303961fa2b`, and the exact replay output tree SHA256 is `1099e3bd7014657a25cacf50fab457f286dcab968c1ddfe76ed42d1f78027831`.
- Root cause is confirmed as host-side XSCT Tcl signed-32-bit conversion in historical `lsort -integer`: the four observed terminal latencies were 17,875,676,347; 26,957,722,756; 51,321,168,692; and 45,147,234,789 ticks, all above 2,147,483,647. Production Tcl now sorts with an explicit wide-integer comparator. XSCT 2023.1 reproduced the exact historical error and passed the fixed comparator; 70 focused package/history/tamper/wrapper/summarizer tests passed in one invocation. Machine validation is `evidence/generated/p7_r41_postfailure_validation.json`. This fix is offline-validated only: no hardware or stationary rerun occurred, and it cannot promote r41, Stage 66, stationary, P7 hardware acceptance, or product acceptance.
- Current safe terminal state is therefore a frozen, evidence-backed formal failure, not a ready next run. No new formal ID, authorization, or Stage 66 attempt exists under the current single-attempt constraint. No Ethernet or motion was used, and the maximum lane mask remained `0x3`.
