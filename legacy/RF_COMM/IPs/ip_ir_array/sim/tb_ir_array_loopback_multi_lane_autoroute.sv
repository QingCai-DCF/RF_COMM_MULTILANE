...
module tb_ir_array_loopback_multi_lane_autoroute;
  ...
  initial begin
    ...
    packet_len[0] = 16;
    packet_map_id[0] = 0;
    packet_good_src_mask[0] = 4'b1000;
    packet_len[1] = 16;
    packet_map_id[1] = 1;
    packet_good_src_mask[1] = 4'b0100;
    packet_len[2] = 16;
    packet_map_id[2] = 2;
    packet_good_src_mask[2] = 4'b0010;
    packet_len[3] = 16;
    packet_map_id[3] = 3;
    packet_good_src_mask[3] = 4'b0001;
  ...
  initial begin
    repeat (24000000) begin
      ...
      if (sender_done && (sent_packets == PACKET_COUNT) && (rx_packet_idx == PACKET_COUNT) &&
          ...
          !a_tx_packet_active && !a_tx_packet_loading && !b_rx_ctx_valid && !b_rx_ctx_complete &&
          (a_lane_tx_busy_dbg == '0) && (b_lane_tx_busy_dbg == '0)) begin
        $display("LOOPBACK_MULTI_LANE_AUTOROUTE_PASS packets=%0d good_src=%04b,%04b,%04b,%04b tx_attempts=%04b,%04b,%04b,%04b",
          PACKET_COUNT,
          packet_good_src_mask[0], packet_good_src_mask[1], packet_good_src_mask[2], packet_good_src_mask[3],
          pkt_a_tx_used[0], pkt_a_tx_used[1], pkt_a_tx_used[2], pkt_a_tx_used[3]);
        $finish;
      end
    end
