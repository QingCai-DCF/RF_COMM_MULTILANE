...
proc update_PARAM_VALUE.STREAM_TX_REQUIRE_ACK { PARAM_VALUE.STREAM_TX_REQUIRE_ACK } {
	# Procedure called to update STREAM_TX_REQUIRE_ACK when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.STREAM_TX_REQUIRE_ACK { PARAM_VALUE.STREAM_TX_REQUIRE_ACK } {
	# Procedure called to validate STREAM_TX_REQUIRE_ACK
	return true
}
...
proc update_MODELPARAM_VALUE.STREAM_TX_REQUIRE_ACK { MODELPARAM_VALUE.STREAM_TX_REQUIRE_ACK PARAM_VALUE.STREAM_TX_REQUIRE_ACK } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.STREAM_TX_REQUIRE_ACK}] ${MODELPARAM_VALUE.STREAM_TX_REQUIRE_ACK}
}
