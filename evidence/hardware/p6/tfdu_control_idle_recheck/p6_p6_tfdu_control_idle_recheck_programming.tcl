set log_file {C:/Users/user/Documents/RF_COMM_MULTILANE/evidence/hardware/p6/tfdu_control_idle_recheck/p6_p6_tfdu_control_idle_recheck_programming.log}
set ila_dir {C:/Users/user/Documents/RF_COMM_MULTILANE/evidence/hardware/p6/ila/tfdu_control_idle_recheck}
file mkdir $ila_dir
...
say "P6_P6_TFDU_CONTROL_IDLE_RECHECK_PROGRAM_BEGIN [clock format [clock seconds] -format %Y-%m-%dT%H:%M:%S%z]"
set bit_file {C:/Users/user/Documents/RF_COMM_MULTILANE/evidence/hardware/p6/bitstreams/p6_tfdu_idle_08f3bc790fb8da67c642c69f695e9bcd66b27a40030be971d2d7d9bb4cbbc442.bit}
if {![file exists $bit_file]} {
  say "P6_P6_TFDU_CONTROL_IDLE_RECHECK_BITSTREAM_MISSING=$bit_file"
  close $fh
  exit 20
}
set ltx_file {C:/Users/user/Documents/RF_COMM_MULTILANE/evidence/hardware/p6/bitstreams/p6_tfdu_idle_aeca9440d645b5144d5df67f2bf074125a08807d937a1215f1a4bd16ac395723.ltx}
set rc [catch {
  open_hw_manager
  ...
  foreach prop {NAME PART IDCODE IS_PROGRAMMED PROGRAM.FILE} {
    if {[catch {set value [get_property $prop $dev]} prop_err]} {
      say "P6_P6_TFDU_CONTROL_IDLE_RECHECK_DEVICE_PROP $prop ERROR=$prop_err"
    } else {
      say "P6_P6_TFDU_CONTROL_IDLE_RECHECK_DEVICE_PROP $prop=$value"
    }
  }
  set_property PROGRAM.FILE $bit_file $dev
  if {$ltx_file ne "" && [file exists $ltx_file]} {
    set_property PROBES.FILE $ltx_file $dev
    say "P6_P6_TFDU_CONTROL_IDLE_RECHECK_PROBES_FILE=$ltx_file"
  } else {
    say "P6_P6_TFDU_CONTROL_IDLE_RECHECK_PROBES_FILE=MISSING"
  }
  ...
  say "P6_P6_TFDU_CONTROL_IDLE_RECHECK_BITSTREAM_PROGRAMMED=$bit_file"
  set ilas [get_hw_ilas -quiet *]
  say "P6_HW_ILA_COUNT=[llength $ilas]"
  set capture_pass 0
  set capture_idx 0
  foreach ila $ilas {
    set wdb_file [file join $ila_dir "p6_tfdu_control_idle_recheck_${capture_idx}.wdb"]
    set csv_file [file join $ila_dir "p6_tfdu_control_idle_recheck_${capture_idx}.csv"]
    set ila_rc [catch {
      current_hw_ila $ila
  ...
  say "P6_P6_TFDU_CONTROL_IDLE_RECHECK_PROGRAM=PASS"
  catch {close_hw_target}
  catch {disconnect_hw_server}
  catch {close_hw_manager}
} err opts]
if {$rc != 0} {
  say "P6_P6_TFDU_CONTROL_IDLE_RECHECK_PROGRAM=FAIL"
  say "P6_P6_TFDU_CONTROL_IDLE_RECHECK_PROGRAM_ERROR=$err"
  catch {close_hw_target}
  catch {disconnect_hw_server}
  catch {close_hw_manager}
  close $fh
