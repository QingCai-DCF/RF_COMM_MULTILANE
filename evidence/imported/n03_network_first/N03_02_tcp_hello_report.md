...
Offline HELLO/STATUS path and plan-sized 10x reconnect tooling are covered by the latest offline gate when present. Real board HELLO/GET_BUILD_ID/PING transcript remains required. Offline reconnect report: `reports/n03_offline_reconnect_matrix_current.md`.
