...
N03 command frame covers PING, GET_VERSION, GET_BUILD_ID, READ commands, CONFIG mode, CLEAR, START, STOP, SHUTDOWN_SAFE, and IR-deferred negative commands in offline/mock evidence.
