...
The full real 16..8192 byte throughput matrix is not yet run. Current offline evidence covers localhost payload matrix tooling, segmentation, ACK/RX echo, and metric capture without claiming real board throughput. Offline matrix report: `reports/n03_offline_payload_matrix_current.md`.
