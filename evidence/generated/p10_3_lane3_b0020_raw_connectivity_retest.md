# P10.3 lane3 bidirectional raw-connectivity retest after F3 replacement

- Result: `FAIL`
- Evidence class: `RAW_PHYSICAL_ONLY`
- Run ID: `p10_3_raw_20260804T122719Z_d4eef729_3d8cd207_a8459eef`
- Active pair: `F3=B0020` ↔ `R3=B0017`
- Lane mask used: `0x8`

| Direction / requested pulses | Result | Sender final-path TX count | Remote raw RX count | Max TX-high cycles |
|---|---|---:|---:|---:|
| F3_TO_R3 / 64 | FAIL | 64 | 0 | 8 |
| F3_TO_R3 / 1024 | NOT_RUN | - | - | - |
