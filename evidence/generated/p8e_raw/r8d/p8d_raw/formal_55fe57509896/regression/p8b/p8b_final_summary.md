...
- `acceptance_core_path`: `evidence/generated/p8e_raw/r8d/p8d_raw/formal_55fe57509896/regression/p8b/p8b_acceptance_core.json`
- `acceptance_core_sha256`: `c25e3ad0da750caf6f650c844f03ca9c8e100d71a9bb4e2e62394761ebc59eca`
...
- `project_state_after_sha256`: `85bdb7a6fb1c0aa83eb5e34aedc782a6e8e6427b0c34879637708354fd739615`
- `first_failing_case`: `P8B-STATE-NONPROMOTION`
...
```json
{
  ...
  "python_model_artifacts": [
    ...
    },
    {
      ...
      "sha256": "9b0d02c4f8c5bd704529f8206d4172011604a129b62f8edf09555f98a4b81a73"
    }
  ],
  "random_seeds": [
    1,
  ...
  "tests": [
    ...
    },
    {
      "details": {
        "expected": {
          "current_program_stage": "P8D_SELECTIVE_REPEAT_SACK_DMA_DATA_PLANE",
        ...
        "mismatches": {
          "current_program_stage": {
            "actual": "P8E_DUAL_TARGET_BUILD_CDC_RESOURCE_TIMING",
            "expected": "P8D_SELECTIVE_REPEAT_SACK_DMA_DATA_PLANE"
          }
        }
      },
