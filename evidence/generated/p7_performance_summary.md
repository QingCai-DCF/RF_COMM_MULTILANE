...
RESULT: PASS
REASON: bytes, goodput, latency, queue, retry, safety, and lane metrics are complete and source-labeled
...
- `D:\CodexWorktrees\p7formal_911e1a3\RF_COMM_MULTILANE\evidence\hardware\p7\authorized_sequence\p7_20260717_stationary_app_r74_formal_full\066_p7_ps_stationary\p7_ps_application_stage_summary.json`
...
- `application_goodput_bps`: `81100`
- `backpressure_events`: `2`
- `bytes_completed`: `18247680`
- `bytes_requested`: `18247680`
- `duty_violation_count`: `0`
- `failures`: `[]`
- `fallback_lane0_to_lane1`: `8`
- `fallback_lane1_to_lane0`: `8`
- `fragment_latency_max_us`: `17592856.976807`
- `fragment_latency_mean_us`: `11527.766374`
- `fragment_latency_min_us`: `1380.48896`
- `fragment_latency_p50_us`: `3767.942891`
- `fragment_latency_p95_us`: `18401.453466`
- `fragment_latency_p99_us`: `70587.648953`
- `fragment_latency_sample_count`: `84900`
- `fragments_completed`: `84900`
- `fragments_duplicated`: `0`
- `fragments_generated`: `84900`
- `fragments_out_of_order`: `0`
- `fragments_rejected`: `0`
- `fragments_retried`: `0`
- `fragments_submitted`: `84900`
- `host_to_ps_bits_per_sec`: `485652`
- `host_to_ps_bytes_per_sec`: `60706`
- `host_to_ps_input_bytes`: `2428928`
- `host_to_ps_input_duration_ms`: `40011`
- `lane0_fragments`: `77815`
- `lane1_fragments`: `41231`
- `latency_percentile_method`: `nearest_rank`
- `max_txd_high_cycles`: `8`
- `object_latency_max_ms`: `93782.778892`
- `object_latency_mean_ms`: `26329.714688`
- `object_latency_min_ms`: `187.426534`
- `object_latency_p95_ms`: `93225.410528`
- `object_latency_sample_count`: `60`
- `objects_completed`: `60`
- `objects_failed`: `0`
- `objects_requested`: `60`
- `p6_crc_bad`: `0`
- `p6_payload_mismatch`: `0`
- `p6_retry_count`: `0`
- `p6_retry_exhausted`: `0`
- `p6_tx_fail`: `0`
- `ps_counts_per_second`: `333333343`
- `ps_runtime_elapsed_ticks`: `600000954718`
- `queue_high_watermark`: `8`
- `replicated_fragments`: `34146`
- `sha256_mismatches`: `0`
- `shutdown_result`: `0`
- `time_sources`: `{'application_goodput_bps': 'PS global timer runtime_elapsed_ticks over completed application bytes', 'fragment_latency': 'PS global timer ticks around each P6 fragment transport operation', 'host_to_ps_bytes_per_sec': 'Tcl host wall clock milliseconds around the initial XSDB dow -data preload; includes JTAG host overhead and is not optical latency', 'object_latency': 'PS global timer ticks around complete object processing'}`
- `validated`: `True`
