...
```json
{
  ...
  "exit_gates": {
    ...
    "BOUNDED_SELECTIVE_REPEAT_TX": "FAIL",
  ...
  "failures": [
    "BOUNDED_SELECTIVE_REPEAT_TX",
    "GLOBAL_OUTSTANDING_32",
    "OFFLINE_FULL_REGRESSION",
    "P0_P8C_REGRESSION",
    "RETRY_EXHAUSTION_BOUNDED",
    "tb_ir_selective_repeat_tx"
  ],
  "generated_utc": "2026-07-28T18:22:37.996948Z",
  ...
  "no_hardware_scan": {
    ...
    "NO_HARDWARE": "1",
    "existing_scan": "PASS",
    "existing_scan_log": "evidence/generated/p9_final_source_p8d_cac64c78/p8d_raw/formal_cac64c78191a/no_hardware_existing_scan.log",
    "p8d_forbidden_hits": [],
    "status": "PASS",
  ...
  "profile": "P8D_MULTI_PROFILE_OFFLINE",
  "schema_version": 1,
  "selected_raw_run": "evidence/generated/p9_final_source_p8d_cac64c78/p8d_raw/formal_cac64c78191a",
