...
- physical F/R role binding by JTAG cable serial: `BOUND_EXPLICIT_SERIAL_TO_ROLE: AX7020-F=210249855178, AX7020-R=210512180081`.
...
Result: `READY_FOR_SCOPED_P10_HARDWARE`. Artifact generation itself executed no hardware action. Every active stage still requires shutdown-before/on-error/after and the no-intentional-power-cycle scope.
