...
RESULT: PASS
REASON: the first 300 seconds of the same unique run supplied exactly ten clean calibration samples
...
- `acceptance_to_calibration_ratio`: `1.0113802189957273`
- `additional_calibration_runtime_sec`: `0`
- `baseline_cumulative_at_300_seconds`: `{'sample_sequence': 10, 'elapsed_sec': 300.0, 'objects_completed': 12, 'bytes_completed': 3674112, 'logical_fragments_completed': 17094, 'lane0_fragment_transmissions': 15559, 'lane1_fragment_transmissions': 6413, 'replicated_logical_fragments': 4878, 'physical_fragment_transmissions': 21972, 'lane0_physical_transmission_fraction': 0.7081285272164574, 'lane1_physical_transmission_fraction': 0.2918714727835427, 'replicated_logical_fragment_fraction': 0.28536328536328537, 'controlled_fallback_events': 4, 'queue_high_watermark': 8, 'backpressure_events': 1, 'time_source': 'PS global timer sample 10 at the embedded 300-second boundary'}`
- `transport_interval_latency`: `{'definition': 'full PS object-processing interval from a valid descriptor entering RUNNING through output CRC32/SHA256 completion, excluding host descriptor publication and JTAG terminal observation', 'time_source': 'PS global timer', 'percentile_scope': 'each 30-second calibration interval; interval percentiles are not merged into a synthetic global percentile', 'interval_count': 10, 'nonempty_interval_count': 5, 'observation_count': 12, 'minimum_ticks': 77408600, 'weighted_interval_mean_ticks': 7905117871.833333, 'interval_p50_ticks': [0, 1478013030, 1867945413, 0, 0, 1653964245, 0, 0, 30716944810, 2049836259], 'interval_p95_ticks': [0, 17974798671, 1899222186, 0, 0, 31260927204, 0, 0, 30716944810, 2156912524], 'interval_p99_ticks': [0, 17974798671, 1899222186, 0, 0, 31260927204, 0, 0, 30716944810, 2156912524], 'maximum_ticks': 31260927204, 'intervals': [{'sample_sequence': 1, 'elapsed_sec': 30.0, 'observation_count': 0, 'minimum_ticks': 0, 'mean_ticks': 0, 'p50_ticks': 0, 'p95_ticks': 0, 'p99_ticks': 0, 'maximum_ticks': 0}, {'sample_sequence': 2, 'elapsed_sec': 60.0, 'observation_count': 2, 'minimum_ticks': 1478013030, 'mean_ticks': 9726405850, 'p50_ticks': 1478013030, 'p95_ticks': 17974798671, 'p99_ticks': 17974798671, 'maximum_ticks': 17974798671}, {'sample_sequence': 3, 'elapsed_sec': 90.0, 'observation_count': 2, 'minimum_ticks': 1867945413, 'mean_ticks': 1883583799, 'p50_ticks': 1867945413, 'p95_ticks': 1899222186, 'p99_ticks': 1899222186, 'maximum_ticks': 1899222186}, {'sample_sequence': 4, 'elapsed_sec': 120.0, 'observation_count': 0, 'minimum_ticks': 0, 'mean_ticks': 0, 'p50_ticks': 0, 'p95_ticks': 0, 'p99_ticks': 0, 'maximum_ticks': 0}, {'sample_sequence': 5, 'elapsed_sec': 150.0, 'observation_count': 0, 'minimum_ticks': 0, 'mean_ticks': 0, 'p50_ticks': 0, 'p95_ticks': 0, 'p99_ticks': 0, 'maximum_ticks': 0}, {'sample_sequence': 6, 'elapsed_sec': 180.0, 'observation_count': 4, 'minimum_ticks': 77408600, 'mean_ticks': 8734387178, 'p50_ticks': 1653964245, 'p95_ticks': 31260927204, 'p99_ticks': 31260927204, 'maximum_ticks': 31260927204}, {'sample_sequence': 7, 'elapsed_sec': 210.0, 'observation_count': 0, 'minimum_ticks': 0, 'mean_ticks': 0, 'p50_ticks': 0, 'p95_ticks': 0, 'p99_ticks': 0, 'maximum_ticks': 0}, {'sample_sequence': 8, 'elapsed_sec': 240.0, 'observation_count': 0, 'minimum_ticks': 0, 'mean_ticks': 0, 'p50_ticks': 0, 'p95_ticks': 0, 'p99_ticks': 0, 'maximum_ticks': 0}, {'sample_sequence': 9, 'elapsed_sec': 270.0, 'observation_count': 1, 'minimum_ticks': 30716944810, 'mean_ticks': 30716944810, 'p50_ticks': 30716944810, 'p95_ticks': 30716944810, 'p99_ticks': 30716944810, 'maximum_ticks': 30716944810}, {'sample_sequence': 10, 'elapsed_sec': 300.0, 'observation_count': 3, 'minimum_ticks': 1780192859, 'mean_ticks': 1995647214, 'p50_ticks': 2049836259, 'p95_ticks': 2156912524, 'p99_ticks': 2156912524, 'maximum_ticks': 2156912524}]}`
...
- goodput uses a causal trailing-300-second completed-byte window sampled every 30 seconds; latency percentiles remain per-30-second interval and are not merged into a synthetic global percentile
