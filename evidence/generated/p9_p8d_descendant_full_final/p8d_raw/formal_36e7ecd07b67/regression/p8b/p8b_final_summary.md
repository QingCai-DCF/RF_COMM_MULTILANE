...
- `acceptance_core_path`: `evidence/generated/p9_p8d_descendant_full_final/p8d_raw/formal_36e7ecd07b67/regression/p8b/p8b_acceptance_core.json`
- `acceptance_core_sha256`: `e8f0e709b1212fb6eb813e21276af26602349924d2712fd65295eae5c3cb1647`
...
- `project_state_after_sha256`: `0c88eaaf7df1c32feabe548f78e63b63e2230349289690089b7616af6df66661`
- `first_failing_case`: `P8B-NO-HARDWARE-STATIC-SCAN`
...
```json
{
  ...
  "python_model_artifacts": [
    ...
    },
    {
      ...
      "sha256": "734c2c0951fc170f7c871b7e754e77badc696c1870ce6c8925f8f353984b931b"
    }
  ],
  "random_seeds": [
    1,
  ...
  "tests": [
    ...
    },
    {
      "details": {
        "NO_HARDWARE": "1",
        "existing_scan_returncode": 1,
        "hardware_actions_executed": false,
        "static_scan_stdout": "NO_HARDWARE_ACTIONS_EXECUTED=0\nscripts\\hw\\p9_hw_preflight.tcl contains open_hw without explicit allow-hardware gate\nscripts\\hw\\p9_hw_preflight.tcl contains connect_hw_server without explicit allow-hardware gate\nscripts\\hw\\p9_program_shutdown.tcl contains open_hw without explicit allow-hardware gate\nscripts\\hw\\p9_program_shutdown.tcl contains connect_hw_server without explicit allow-hardware gate\nscripts\\hw\\p9_program_shutdown.tcl contains program_hw_devices without explicit allow-hardware gate"
      },
