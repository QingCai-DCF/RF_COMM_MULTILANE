...
- mandatory stage evidence is internally inconsistent: lane_fallback
- mandatory stage evidence is internally inconsistent: abort_restart
- p7_run_sequence_ledger.json is missing after hardware execution
