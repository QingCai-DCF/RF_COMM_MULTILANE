...
- Status: `PASS_WITH_QUICK_MODE_SKIPS`
...
```json
{
  ...
  "exit_gates": {
    ...
    "OFFLINE_FULL_REGRESSION": "SKIP_WITH_REASON",
    "P0_P8C_REGRESSION": "SKIP_WITH_REASON",
  ...
  "failures": [],
  "generated_utc": "2026-07-29T02:11:08.578035Z",
  ...
  "no_hardware_scan": {
    ...
    "NO_HARDWARE": "1",
    "existing_scan": "PASS",
    "existing_scan_log": "evidence/generated/p9_scheduler_recovery_fix_quick/p8d_raw/quick_7adbd8fbee27_attempt_001/no_hardware_existing_scan.log",
    "p8d_forbidden_hits": [],
    "status": "PASS",
  ...
  "profile": "P8D_MULTI_PROFILE_OFFLINE",
  "schema_version": 1,
  "selected_raw_run": "evidence/generated/p9_scheduler_recovery_fix_quick/p8d_raw/quick_7adbd8fbee27_attempt_001",
