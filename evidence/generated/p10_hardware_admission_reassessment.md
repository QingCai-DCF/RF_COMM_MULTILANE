...
- Result: `PASS_POWER_STATE_RECLASSIFIED_ROLE_BINDING_REQUIRED`.
...
- Current P10 hardware admission: `false`.
- Current blocker: `P10-ROLE-BINDING-001`.
- JTAG role state: `ENUMERATED_UNASSIGNED: 210249855178, 210512180081`.
