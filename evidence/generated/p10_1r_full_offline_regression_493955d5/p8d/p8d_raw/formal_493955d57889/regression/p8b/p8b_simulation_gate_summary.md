...
```json
{
  ...
  "mapping_unit": {
    ...
    "log_path": "build/p10_1r_p8d_exact_branch/p8d_raw/formal_493955d57889/regression/p8b/p8b_xsim/mapping_unit.log",
  ...
  "phase_trajectory": {
    ...
    "log_path": "build/p10_1r_p8d_exact_branch/p8d_raw/formal_493955d57889/regression/p8b/p8b_xsim/phase_trajectory.log",
