...
```json
{
  ...
  "commands": {
    "p8b_checkpoint_evidence_verify": {
      "log": "evidence/generated/p8c_raw/p8b_checkpoint_evidence_verify.log",
      "status": "PASS"
    },
    "python_reference": {
      "log": "evidence/generated/p8c_raw/python_reference.log",
      "status": "PASS"
    },
    "python_unit_tests": {
      "log": "evidence/generated/p8c_raw/python_unit_tests.log",
      "status": "PASS"
    },
    "register_map_verify": {
      "log": "evidence/generated/p8c_raw/register_map_verify.log",
      "status": "PASS"
    },
    "safety_config_verify": {
      "log": "evidence/generated/p8c_raw/safety_config_verify.log",
      "status": "PASS"
    },
    "static_architecture": {
      "log": "evidence/generated/p8c_raw/static_architecture.log",
      "status": "PASS"
    }
  },
  "failures": [],
  ...
  "software": {
    "log": "evidence/generated/p8c_raw/software/ps_driver_host_compile_and_run.log",
    "status": "PASS"
  },
  ...
  "xsim": {
    "tb_p8c_endpoint_safety": {
      "log_directory": "evidence/generated/p8c_raw/xsim/tb_p8c_endpoint_safety",
      "markers": [
    ...
    "tb_p8c_exact_duty": {
      "log_directory": "evidence/generated/p8c_raw/xsim/tb_p8c_exact_duty",
      "markers": [
    ...
    "tb_p8c_full_scale": {
      "log_directory": "evidence/generated/p8c_raw/xsim/tb_p8c_full_scale",
      "markers": [
    ...
    "tb_p8c_physical_safety": {
      "log_directory": "evidence/generated/p8c_raw/xsim/tb_p8c_physical_safety",
      "markers": [
    ...
    "tb_p8c_profile_matrix": {
      "log_directory": "evidence/generated/p8c_raw/xsim/tb_p8c_profile_matrix",
      "markers": [
    ...
    "tb_p8c_safety_regs": {
      "log_directory": "evidence/generated/p8c_raw/xsim/tb_p8c_safety_regs",
      "markers": [
    ...
    "tb_p8c_trace_crosscheck": {
      "log_directory": "evidence/generated/p8c_raw/xsim/tb_p8c_trace_crosscheck",
      "markers": [
    ...
    "tb_tfdu_lane_phy_smoke": {
      "log_directory": "evidence/generated/p8c_raw/xsim/tb_tfdu_lane_phy_smoke",
      "markers": [
