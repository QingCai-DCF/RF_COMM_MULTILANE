...
model-integration testbench instantiates `tfdu6102_behavior_model` and decodes
low-active `Rxd` through the abstract pulse-stream RX interface. SystemVerilog
simulation remains unclaimed until `iverilog`, `verilator`, or a Vivado batch
simulator is available on PATH.
