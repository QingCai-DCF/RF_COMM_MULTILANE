...
the gate proves it can detect missed pulse offsets. Current PATH discovery
records `IVERILOG_ON_PATH=0`, `VERILATOR_ON_PATH=0`, and `VIVADO_PATH_ON_PATH=0`,
while the D:\Xilinx\Vivado\2023.1\bin `xvlog.bat`/`xelab.bat`/`xsim.bat`
toolchain is available and passes the M2 SystemVerilog simulation gates.
