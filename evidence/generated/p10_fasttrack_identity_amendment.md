...
- `P10-SAFETY-POWERUP-001`: `PENDING_D17_NONBLOCKING_FOR_P10_SCOPED_NO_POWER_CYCLE_RUN`; D17 remains pending.
- Active-hardware admission: `READY_FOR_SCOPED_P10_HARDWARE` (`NONE`).
