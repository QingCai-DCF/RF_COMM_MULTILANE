...
def main() -> int:
    ...
    require("write_bitstream" in tcl, "M5_SAFE_IDLE_BITSTREAM_GENERATION_NO_HW", errors)
    require("BITSTREAM_GENERATED_NO_HW" in runner and "bitstream_sha256" in runner, "M5_RUNNER_RECORDS_SAFE_IDLE_BITSTREAM", errors)
