...
P9_Z7010_STATIONARY_2LANE_PLATFORM_LIMITED_HARDWARE_VALIDATION: IN_PROGRESS
CURRENT_PROGRAM_STAGE: P9_Z7010_STATIONARY_2LANE_PLATFORM_LIMITED_HARDWARE_VALIDATION
...
| Gate | Status |
|---|---|
| `P9` | `IN_PROGRESS_CURRENT_RUN_AUTHORIZED` |
