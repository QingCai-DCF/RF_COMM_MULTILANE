# XSCT board bring-up script for the RF_COMM PS-PS loopback experiment.
#
# Usage from the repository root:
#   & 'D:\Xilinx\Vitis\2023.1\bin\xsct.bat' '.\software\ps_ps_loopback\run_on_hw.tcl'
#
# Optional hw_server URL:
#   & 'D:\Xilinx\Vitis\2023.1\bin\xsct.bat' '.\software\ps_ps_loopback\run_on_hw.tcl' TCP:localhost:3121
...
puts "RF_COMM PS-PS loopback hardware run"
puts "  bit:  $bit_file"
puts "  elf:  $elf_file"
puts "  init: $init_file"
...
puts "PS-PS loopback started. Check UART for packet loss and throughput."
